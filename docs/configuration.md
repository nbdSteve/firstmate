...
FM_WATCH_ARM_SHUTDOWN_TIMEOUT_MS=8000   # milliseconds Pi/OpenCode wait for the full-session-teardown fm-watch-arm.sh --shutdown stop of the detached watcher
